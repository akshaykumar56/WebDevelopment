...
const News = (props)=>{
    ...
    const updateNews = async ()=> {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=bc0a9b7b55984f7899cc8a1d2c5ab5ad&page=${page}&pageSize=${props.pageSize}`; 
        setLoading(true)
