...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#404040'}}> 
            ...
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleLoClick} style={{backgroundColor: props.mode==='dark'?'black':'black', color: props.mode==='dark'?'#B3B3B3':'white'}}>Convert to Lowercase</button>
